...
Production-grade Claude Code skill for the Satelink DePIN Network.
...
.claude/CLAUDE.md             — Project brain (read every session)
```
...
1. Read `.claude/CLAUDE.md` (project brain)
