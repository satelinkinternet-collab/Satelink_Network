...
import { DemandBuffer } from "../../../../server.js";
...
describe.skip("Revenue Split & Infra Reserve Test", function () {
    ...
    before(async function () {
        ...
        await agent.post("/services/services/nodes/bootstrap-payment").set("X-Admin-Key", ADMIN_API_KEY).send({ nodeWallet: nodeManaged, nodeType: 'managed' });
